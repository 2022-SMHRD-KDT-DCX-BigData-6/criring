...
function searchPlaces() {
	...
	var keyword = document.getElementById('keyword').value + "코인세탁방";
...
function createSelectMarker(marker, title) {
	var selectstore = document.getElementById('selectStore');
	selectstore.innerHTML = '<input type="text" name="selectStoreOne" class="dp-none" id="selectStore-dp-none">'
	var addStore = document.getElementById('selectStore-dp-none');
	addStore.value = title;
	var reservationLat = document.getElementById('reservation-Lat');
	reservationLat.innerHTML = '<input type="text" name="selectStoreLat" class="dp-none" id="selectStoreLat-dp-none">'
	var addStoreLat = document.getElementById('selectStoreLat-dp-none');
	addStoreLat.value = marker.getPosition().getLat();
	var reservationLng = document.getElementById('reservation-Lng');
	reservationLng.innerHTML = '<input type="text" name="selectStoreLng" class="dp-none" id="selectStoreLng-dp-none">'
	var addStoreLng = document.getElementById('selectStoreLng-dp-none');
	addStoreLng.value = marker.getPosition().getLng();
