	   ...
	   <section class="banner-section d-flex justify-content-center align-items-end">
		...
		<section class="d-flex justify-content-center align-items-end">
	   		<div class="container">
	   			<div class="row">
	   				<!-- 답글 세부내용 조회 -->   
	   				<h2 class="replytitle">답글입니다.</h2>
				    <hr>
				    <h5 class="replywriter">작성자 : 관리자</h5><br>
				    <hr>
				    <h5>내용</h5>
			     	<div class="row">
				    <textarea class="replytext" rows="10" cols="50" readonly="readonly"><%=aDto.getReplyContent()%></textarea>
					...
					<div class="replybtngroup">
			               ...
			               <%} %>
			               <a href="requestBoardMain.jsp?boardPage=<%=boardPage%>"><button class="replybtn" style="width: 76px;">돌아가기</button></a>  
					</div>   
	   			</div>
	   		</div>
		</section>
