	         	...
	         	<div class="row">
					...
					<div class="row">
			            <form action="replyInsert" method="post" enctype="multipart/form-data">
							<h5>내용</h5>
							<textarea rows="6" name="reply_content" class="form-control"
								style="resize: none; margin-bottom: 10px"></textarea>
							<input type="file" class="form-control" name="reply_photo" style="margin-bottom: 20px;"/>  <input type="submit" class="replybtn"
								value="작성하기">
								<input
								type="reset" class="replybtn" value="초기화">
								<a href="requestBoardMain.jsp?boardPage=<%=boardPage%> %>"
								class="replyBack"><input type="button" class="replybtn" value="돌아가기"></a>
			            </form>
					</div>
		         </div>
	         </div>
